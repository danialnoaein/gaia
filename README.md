...
```
cd existing_repo
git remote add origin https://gitlab.eaicon-it.de/gaia/quicknote.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eaicon-it.de/gaia/quicknote/-/settings/integrations)
